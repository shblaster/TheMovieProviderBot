...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/Howto_openthislink/7') # How to open tutorial link for verification
...
if HAS_SSL:
    URL = "http://samantha-botz-0b9a1360768a.herokuapp.com/".format(FQDN)
else:
    URL = "http://samantha-botz-0b9a1360768a.herokuapp.com/".format(FQDN)
